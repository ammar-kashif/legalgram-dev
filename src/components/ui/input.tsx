  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-md border border-input bg-background px-4 py-2 text-base ring-offset-background transition-all duration-150",
          ...
          "md:text-sm text-foreground dark:text-white",
          className
        )}
        ref={ref}
        {...props}
